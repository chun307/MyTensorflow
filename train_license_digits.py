...
if __name__ == '__main__' and sys.argv[1] == 'train':
    ...
    # 定义对应维数和各维长度的数组
    # 定义2维数组input_images[SIZE][input_count] 默认值都为0 by chun
    ...
    with tf.Session() as sess:
        ...
        for it in range(iterations):
            ...
            if it % 5 == 0:
                ...
                #原来为 if iterate_accuracy >= 0.9999 and it >= iterations:
                if iterate_accuracy >= 0.9750 and it >= 50:
                    break;
...
if __name__ == '__main__' and sys.argv[1] == 'predict':
    ...
    with tf.Session() as sess:
        ...
        write = tf.summary.FileWriter("path/to/log", tf.get_default_graph())
        write.close()
        for n in range(3, 8):
